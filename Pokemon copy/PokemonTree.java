...
public class PokemonTree {
  ...
  public boolean isEmpty() {
    ...
    return this.size == 0 || root == null; // remove this statement. A default return statement
    // added to let this
    // code
    // compile.
  }
  ...
  public int size() {
    // TODO Complete the implementation of this method.
    return this.size; // remove this statement. A default return statement added to let this code
    // compile.
  }
  ...
  public boolean addPokemon(Pokemon newPokemon) {
    ...
    if (isEmpty()) { // Add new to an empty PokemonTree
      ...
      // TODO /* MISSING CODE */
      flag = addPokemonHelper(newPokemon, root);
      if (flag == true) {
        size++;
      }
    }
  ...
  public Pokemon getLeastPowerfulPokemon() {
    ...
    return p.getPokemon(); // added to let this incomplete code compile
  }
