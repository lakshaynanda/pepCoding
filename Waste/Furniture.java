...
/**
 * This class models Furniture objects which can be added to an inventory. Each
 * object contains a furniture's inventory number, a name, and weight, with
 * accessors for these three data fields.
 *
 * TODO: Modify this class to implement the Comparable interface, so that a
 * Furniture object can be compared to another Furniture object, and any
 * collection of Furniture objects can be sorted.
 *
 * Note: Do NOT add any additional data fields! You are allowed to add private
 * helper methods if needed. Note: MAKE SURE TO SAVE your source file before
 * uploading it to gradescope.
 */
class Furniture implements Comparable<Furniture> {
	...
	public Furniture(String name, int weight) {
		this.name = name;
		this.weight = weight;
		// TODO: Complete the implementation of this constructor to initialize all the
		// instance fields
	...
	/**
	 * Should return true if and only if the Object o is a Furniture with the same
	 * name as this one.
	 *
	 * @param o the Object to compare to
	 * @return true if the Object is a Furniture, and this furniture and object have
	 *         equal names; false otherwise
	 */
	@Override
	...
	// A furniture is greater than another furniture if its weight is higher than
	// the other
	// furniture's weight.
	// Two furniture items are equal if they have the same weight.
	// A furniture item is smaller than another furniture item if its weight is
...
/**
 * The FurnitureInventory class contains various Furniture objects, and offers
 * various utility methods for analyzing the contents of this inventory. Note:
 * Do NOT add any additional data fields! You are allowed to add private helper
 * methods if needed.
 */
public class FurnitureInventory {

	// private static fields
	private static String[] names = { "desk", "chair", "sofa", "table", "book case", "lamp", "laptop", "desktop",
			"paper shredder", "printer" }; // names of all the furniture objects stored in this
	// inventory
	...
	public static FurnitureInventory copyOf(FurnitureInventory toCopy) {
		// TODO: create a new FurnitureInventory which is a deep copy (not the deepest)
		// of toCopy
		// The two objects will have different ArrayLists objects which contain
		// the same elements

		FurnitureInventory FI = new FurnitureInventory();

		for (Furniture inventory : toCopy.list) {
			FI.addFurniture(new Furniture(inventory.getName(), inventory.getWeight()));
		}

		return FI; // CHANGE THIS, included only to avoid compile errors
	}
	...
	public void addFurniture(Furniture f) {
		// TODO add the provided Furniture to this FurnitureInventory's list and
		// increment its number of
	...
	// accessors
	/**
	 * Calculates the number of occurrences of a specific furniture in the list of
	 * this inventory
	 *
	...
	/**
	 * A private helper method to sort the list of this inventory in ascending
	 * order. Useful for the getHeaviestFurniture() method!
	 *
	 * NOTE: do not uncomment this method until you have correctly implemented the
	 * Comparable interface in the Furniture class; it will cause an error and your
	...
	/**
	 * Gets the inventory id of the heaviest Furniture stored within this
	 * FurnitureInventory
	 *
	 * @return the inventory id of the highest-weight (heaviest) furniture item in
	 *         the list of this FurnitureInventory
	 */
	public int getHeaviestFurniture() {
		// TODO find and return the inventory id of the heaviest Furniture in this
		// FurnitureInventory
		// Hint: implement the Comparable interface for Furniture first, then use the
		// helper method
		// below.

		sortInventory();
		return list.get(list.size() - 1).getInventoryId();
